/*|  Spider Swarm Button
**|  Written by Lumie, shoutouts to Fawful
**|  Version: 2020.09.25b
**@preserve
*/
var Spiders=
...
{if (confirm("Summon the swarm? *Warning, summoning multiple swarms is a bad idea!*")) {
  ...
  var Spiderdance = new Audio('https://cdn.discordapp.com/attachments/757083079289602180/758984846059372544/Spiderdance.mp3')
	Spiderdance.play();
	Spiderdance.volume = 0.1;
...
{Spiders.appendTo("#leftcontrols")}
else{Spiders.prependTo("#leftcontrols")}
...
var BugDispatch = {
    ...
    options: {
        ...
        maxSmallTurnDeg: 10,
        maxWiggleDeg: 5,
        imageSprite: 'https://cdn.discordapp.com/attachments/757083079289602180/758235472694083604/fly-sprite.png',
        bugWidth: 13,
        bugHeight: 14,
        num_frames: 5,
...
var SpiderController = function() {
    var spiderOptions = {
        imageSprite: 'https://cdn.discordapp.com/attachments/757083079289602180/757885885353033809/spider-sprite.png',
        bugWidth: 69,
        bugHeight: 90,
        num_frames: 7,
        canFly: false,
...
/*!
 * Spider Swarm Button – MOTD injection
 */
...
(function () {
    ...
    function makeSpiderBtn() {
      if ($('#Spiders').length) return $('#Spiders');
      ...
      const $btn = $('<button/>', {
        ...
        .css({
          ...
          padding: '6px 10px',
          margin: '4px',
          boxShadow: '0 0 6px #FF6600,0 0 12px #FF6600,0 0 18px #FFB347'
        })
        .on('mouseenter', function () {
          $(this).css({
            background: '#FF6600',
            color: '#000',
            boxShadow: '0 0 8px #FF6600,0 0 16px #FF6600,0 0 24px #FFB347'
          });
        })
